...
import managing.points.PointListAdapter;
...
public class PointListActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pointlog = PointLog.getInstance(this.getApplicationContext());
        records = pointlog.readAllRecords();
        adapter = new PointListAdapter(this, records);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        // create the menu
        getMenuInflater().inflate(R.menu.context_point_list, menu);
        ...
        PointRecord record = records.get(selectedRow);
    }
    ...
    private void deleteTrip() {
        ...
        if (pointlog.deleteTrip(record.getID())) {
