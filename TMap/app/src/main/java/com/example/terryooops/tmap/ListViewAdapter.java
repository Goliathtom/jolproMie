   ...
   // private ArrayList<ListViewItem> listViewItemList = new ArrayList<ListViewItem>() ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // Button dirButton = (Button) convertView.findViewById(R.id.direction) ;
        TextView addrTextView = (TextView) convertView.findViewById(R.id.addr) ;
        TextView priceTextView = (TextView) convertView.findViewById(R.id.price) ;
        TextView distTextView = (TextView) convertView.findViewById(R.id.distance) ;
        TextView useTimeTextView = (TextView) convertView.findViewById(R.id.useTime) ;
        TextView chargerTypeTextView = (TextView) convertView.findViewById(R.id.chargerType) ;
        TextView statTextView = (TextView) convertView.findViewById(R.id.stat) ;
